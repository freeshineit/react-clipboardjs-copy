...
var ReactClipboard = function (_React$Component) {
    ...
    _createClass(ReactClipboard, [{
        ...
        value: function onClick(e) {
            ...
            this.clipboard = new _clipboard2.default(e.target);
        ...
        value: function render() {
            ...
            return _react2.default.cloneElement(elem, _extends({}, other, {
                'data-clipboard-action': action,
                'data-clipboard-text': text,
                'data-clipboard-target': target,
                'onClick': this.onClick.bind(this),
                ref: function ref(ele) {
                    _this2.clipboardBtn = ele;
                }
            }));
        }
    }]);
...
ReactClipboard.propTypes = {
    ...
    selection: _propTypes2.default.bool // 是否选择 默认是选中的  如不需要选中 设置为true
};
